...
export default function Navbar({ onSaveAction, onLoadAction, onOpenEnvAction }: HeaderProps) {
    ...
    return (
        <header className="sticky top-0 h-[70px] w-full px-6 md:px-16 lg:px-24 xl:px-32 flex items-center justify-between z-40 transition-all border-b border-white/10 bg-white/10 dark:bg-white/5 backdrop-blur-xl">
            ...
            <div className="hidden md:flex items-center gap-6">
                ...
                <div className="relative" ref={pagesRef}>
                  <button
                    ...
                    className="text-white px-3 py-1 rounded-md text-sm hover:text-white/80 flex items-center"
                    title="Documents"
                  >
                ...
                <button
                    ...
                    className="px-2 py-1 rounded-md text-sm text-white/80 border border-white/20 hover:text-white transition-colors flex items-center"
                    title="Toggle theme"
                >
            ...
            <div className="md:hidden relative" ref={menuRef}>
                <button
                    ...
                    className="p-2 rounded-md hover:bg-white/10 transition-colors text-primary"
                >
                    <MoreHorizontal className="w-5 h-5" />
                </button>

                {menuOpen && (
                    <div className="absolute top-[70px] left-0 w-full p-4 z-40 border-b border-white/10 bg-white/10 dark:bg-white/5 backdrop-blur-xl">
